...
class ClassicCycleGANModel(BaseModel):
    """
    ...
    def set_input(self, input):
        ...
        inputa = input['A']
        # inputa_mask = input['A_mask']

        inputb = input['B']
        # inputb_mask = input['B_mask']
    ...
    def backward_G(self):
        ...
        # Mask loss 
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B # + self.loss_A_mask
